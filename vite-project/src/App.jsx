    ...
    <div className="page-container">
      <div className="content-wrap">
        ...
        <TopNav
          ...
          email={email}
          name={name}
          setSearchQuery={setSearchQuery} // Pass setSearchQuery down to TopNav
        />
        <Navbar show={isSidebarOpen} email={email} />
        <div className={isSidebarOpen ? 'App shift-content' : 'App'}>
          <Routes>
            <Route path='/' element={<Home toggleSidebar={toggleSidebar} isSidebarOpen={isSidebarOpen} searchQuery={searchQuery} />} />
